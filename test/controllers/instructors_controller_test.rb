...
class InstructorsControllerTest < ActionController::TestCase
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post :create, instructor: { comment: @instructor.comment, email: @instructor.email, first: @instructor.first, id: @instructor.id, last: @instructor.last, middle: @instructor.middle, type: @instructor.type }
    end
  ...
  test "should update instructor" do
    patch :update, id: @instructor, instructor: { comment: @instructor.comment, email: @instructor.email, first: @instructor.first, id: @instructor.id, last: @instructor.last, middle: @instructor.middle, type: @instructor.type }
    assert_redirected_to instructor_path(assigns(:instructor))
  end
